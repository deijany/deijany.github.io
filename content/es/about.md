...
passion_title: "Intereses de Investigación"

passion_text: >-
  Mis principales intereses de investigación incluyen estimación y sincronización, procesamiento de señales con restricciones de hardware, linealización de la respuesta no ideal de ADC/DAC y ecualización de distorsiones en la respuesta en frecuencia. Me interesan especialmente métodos que equilibren rigor teórico, robustez y eficiencia computacional para su despliegue en hardware real y a escala. Un tema recurrente en mi trabajo es el uso de métodos inspirados en el aprendizaje y no supervisados para descubrir estructura, ajustar modelos y mejorar el rendimiento cuando los datos son limitados.

personal: >-
  Fuera de la investigación, disfruto del deporte, la lectura, la música, la escritura técnica y los juegos de mesa colaborativos.
...
quickfacts:
  ...
  - icon: "cogs"
    ...
    value: "Procesamiento de Señales · Estimación y Sincronización · DSP Consciente del Hardware · Linealización · Ecualización"
